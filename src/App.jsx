...
const Portfolio = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-background text-portfolio-text overflow-x-hidden transition-colors duration-500">
      {/* Background decoration */}
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-portfolio-accent/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-portfolio-accent-secondary/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute top-1/2 left-1/2 w-32 h-32 bg-portfolio-accent/5 rounded-full blur-2xl animate-spin-slow"></div>
      </div>

      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-portfolio-card/80 border-b border-portfolio-border transition-colors duration-500">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="text-portfolio-text font-bold text-xl bg-gradient-primary bg-clip-text text-transparent">
              Baudoin B
            </div>
              ...
              {["Home", "About", "Work", "Portfolio", "Contact"].map(
                (section) => (
                  <button
                    key={section}
                    onClick={() => scrollToSection(section.toLowerCase())}
                    className="text-portfolio-text-muted hover:text-portfolio-accent transition-all duration-300 capitalize relative group"
                  >
                    {section}
                    <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-portfolio-accent transition-all duration-300 group-hover:w-full"></span>
                  </button>
                )
              )}
              <ThemeToggle />
              ...
              {["Home", "About", "Work", "Portfolio", "Contact"].map(
                (section) => (
                  <button
                    key={section}
                    onClick={() => scrollToSection(section.toLowerCase())}
                    className="block w-full text-left text-portfolio-text-muted hover:text-portfolio-accent transition-colors capitalize py-2"
                  >
                    {section}
                  </button>
                )
      ...
      >
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="text-portfolio-accent text-lg font-medium flex items-center gap-2">
                <Star className="w-5 h-5 animate-pulse" />
                Hi there,
              </div>
              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                ...
                <br />
                <span className="text-portfolio-text">BOLINGO</span>
              </h1>
              <p className="text-portfolio-text-muted text-lg flex items-center gap-2">
                <Code className="w-5 h-5 text-portfolio-accent" />
                Full-stack Web Developer
              </p>
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <button
                  onClick={() => scrollToSection("contact")}
                  className="border border-portfolio-accent text-portfolio-accent hover:bg-portfolio-accent hover:text-white px-8 py-3 rounded-md transition-all duration-300 flex items-center gap-2 group"
                >
            ...
            <div className="relative">
              <div className="relative w-full max-w-md mx-auto">
                ...
                <div className="relative bg-gradient-card p-8 rounded-2xl border border-portfolio-border backdrop-blur-sm">
                  <div className="w-48 h-48 rounded-full mx-auto mb-6 overflow-hidden border-4 border-portfolio-accent">
                    <img
              ...
              <div className="absolute -top-4 -right-4 flex flex-col space-y-3">
                {[
                  { icon: FaGithub, delay: "0s" },
                  { icon: FaLinkedin, delay: "0.5s" },
                  { icon: FaInstagram, delay: "1s" },
                ].map(({ icon: Icon, delay }, index) => (
                  <div
                    key={index}
                    className="w-12 h-12 bg-portfolio-card/50 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-portfolio-accent/20 cursor-pointer transition-all duration-300 hover:scale-110 border border-portfolio-border"
                    style={{ animationDelay: delay }}
                  >
                    <Icon className="w-6 h-6 text-portfolio-text-muted hover:text-portfolio-accent transition-colors" />
                  </div>
                ))}
              </div>
            </div>
      ...
      <section id="work" className="py-24 relative">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <div className="text-portfolio-accent text-lg mb-4 flex items-center justify-center gap-2">
              <Zap className="w-5 h-5" />
              What I do
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-gradient-card backdrop-blur-sm p-8 rounded-2xl border border-portfolio-border group hover:border-portfolio-accent/50 transition-all duration-300"
              >
                <div
                  className={`text-white mb-4 p-4 rounded-xl bg-gradient-to-r ${service.color} inline-block group-hover:scale-110 transition-transform duration-300`}
                >
                ...
                <h3 className="text-xl font-semibold mb-4 text-portfolio-text group-hover:text-portfolio-accent transition-colors duration-300">
                  {service.title}
                </h3>
                ...
                <ul className="space-y-2">
                  {service.features.map((feature, idx) => (
                    <li
                      key={idx}
                      className="flex items-center gap-2 text-sm text-portfolio-text-muted"
                    >
      ...
      <section id="portfolio" className="py-24 relative">
        <div className="container mx-auto px-6">
          <div className="mb-16">
            <div className="text-portfolio-accent text-lg mb-4 flex items-center gap-2">
              <Star className="w-5 h-5" />
              Portfolio
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
            ...
            <div className="flex space-x-4">
              <button className="text-portfolio-accent border-b-2 border-portfolio-accent pb-2 font-medium hover:bg-portfolio-accent/10 px-4 transition-all duration-300">
                All Projects
              </button>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <div
                key={index}
                className="bg-gradient-card backdrop-blur-sm rounded-2xl border border-portfolio-border overflow-hidden group hover:border-portfolio-accent/50 transition-all duration-300"
              >
                <div className="relative overflow-hidden">
                  <img
                    src={project.image}
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-xl font-semibold text-portfolio-text group-hover:text-portfolio-accent transition-colors duration-300">
                      {project.title}
                    </h3>
                    <span className="text-xs text-portfolio-text-muted bg-portfolio-bg-secondary px-2 py-1 rounded">
                      {project.category}
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className="bg-portfolio-accent/20 text-portfolio-accent px-2 py-1 rounded-md text-xs font-medium"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full flex items-center justify-center gap-2 text-sm bg-portfolio-accent/20 hover:bg-portfolio-accent/30 text-portfolio-accent py-3 rounded-lg transition-all duration-300 border border-portfolio-accent/30"
                  >
                    <ExternalLink className="w-4 h-4" />
                    View Project
                  </a>
      ...
      <section id="about" className="py-24 relative">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="text-portfolio-accent text-lg flex items-center gap-2">
                <Star className="w-5 h-5" />
                About me
              </div>
              <h2 className="text-4xl md:text-5xl font-bold">
            ...
            <div className="relative">
              <div className="relative">
                ...
                <img
                  src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=600&h=400&fit=crop"
                  alt="Code Interface"
                  className="relative w-full h-[400px] rounded-2xl shadow-2xl border border-portfolio-border"
                />
              </div>
              <div className="absolute -bottom-6 -right-6 bg-gradient-primary p-4 rounded-xl">
                <div className="text-white text-center">
                  <div className="text-2xl font-bold">4+</div>
                  <div className="text-sm">Years Experience</div>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div>
                ...
                <p className="text-portfolio-text-muted mb-8 text-lg">
                  Have a question, comment or business concept? This contact
                  form is the best way to get in touch with me.
                </p>
              </div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div
                    key={label}
                    className="flex items-center space-x-4 p-4 bg-gradient-card backdrop-blur-sm rounded-xl border border-portfolio-border"
                  >
                    ...
                    <div>
                      ...
                      <div className="text-portfolio-text-muted">{value}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-gradient-card backdrop-blur-sm p-8 rounded-2xl border border-portfolio-border">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="Your name"
                      className="w-full bg-portfolio-bg-secondary/50 border border-portfolio-border rounded-lg px-4 py-3 text-portfolio-text placeholder:text-portfolio-text-muted focus:outline-none focus:ring-2 focus:ring-portfolio-accent focus:border-transparent transition-all duration-300"
                      required
                      value={formData.name}
                      onChange={(e) =>
                        setFormData({ ...formData, name: e.target.value })
                ...
                <div>
                  ...
                  <textarea
                    placeholder="Tell me about your project..."
                    rows={5}
                    className="w-full bg-portfolio-bg-secondary/50 border border-portfolio-border rounded-lg px-4 py-3 text-portfolio-text placeholder:text-portfolio-text-muted resize-none focus:outline-none focus:ring-2 focus:ring-portfolio-accent focus:border-transparent transition-all duration-300"
                    required
                    value={formData.message}
                    onChange={(e) =>
                      setFormData({ ...formData, message: e.target.value })
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-primary hover:opacity-90 text-white py-3 rounded-lg transition-all duration-300 font-medium"
                >
                  Send Message
                </button>
              </form>
      ...
      {/* Footer */}
      <footer className="py-12 border-t border-portfolio-border bg-portfolio-card/50 backdrop-blur-sm">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                {["Home", "About", "Work", "Portfolio"].map((item) => (
                  <button
                    key={item}
                    onClick={() => scrollToSection(item.toLowerCase())}
                    className="block text-portfolio-text-muted hover:text-portfolio-accent transition-colors duration-300"
                  >
                    {item}
                  </button>
                ))}
            ...
            <div>
              ...
              <div className="flex space-x-4">
                {[FaGithub, FaLinkedin, FaInstagram].map((Icon, index) => (
                  <div
                    key={index}
                    className="w-10 h-10 bg-portfolio-card/50 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-portfolio-accent/20 cursor-pointer transition-all duration-300 hover:scale-110 border border-portfolio-border"
                  >
                    <Icon className="w-5 h-5 text-portfolio-text-muted hover:text-portfolio-accent transition-colors" />
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-portfolio-border text-center text-portfolio-text-muted">
            <p>&copy; 2024 Baudoin Bolingo. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
