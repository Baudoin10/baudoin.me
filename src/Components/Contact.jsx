  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://backend-portfolio-bbj2.onrender.com/api/contact",
        {
          method: "POST",
          headers: {
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="w-full bg-gradient-to-r from-red-500 to-red-400 hover:bg-red-600 text-white py-3 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
